    ...
    return(
		...
		<aside id="colorlib-aside" role="complementary" className="border js-fullheight">
			...
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					<li className="colorlib-active"><a href="/index">Главная</a></li>
		...
		<div id="colorlib-main">
			<aside id="colorlib-hero" className="js-fullheight">
				<div className="flexslider js-fullheight">
					<ul className="slides">
				   	<li style={{backgroundImage: "url(images/slider-1.jpg)"}}>
				   	...
				   	<li style={{backgroundImage:"url(images/slider-2.png)"}}>
				   		<div className="overlay"></div>
				   		<div className="container-fluid">
				   			<div className="row">
					   			<div className="col-md-6 col-md-offset-3 col-md-push-3 col-sm-12 col-xs-12 js-fullheight slider-text">
					   				<div className="slider-text-inner">
					   					<div className="desc">
													<img style={{width: "100px" ,marginBottom: "20px"}} src="images/pay.png"/>
											   <h2 style={{letterSpacing:" 5px"}}>Наличный и
				   	...
				   	<li style={{backgroundImage: "url(images/slider-3.jpg)"}}>
				   		<div className="overlay"></div>
				   		<div className="container-fluid">
				   			<div className="row">
					   			<div className="col-md-6 col-md-offset-3 col-md-push-3 col-sm-12 col-xs-12 js-fullheight slider-text">
					   				<div className="slider-text-inner">
					   					<div className="desc">
											<h2 style={{letterSpacing:"5px"}}>Ежедневно с 8:00 до 22:00 <br></br>
							...
							<div className="row">
								...
								<div className="col-md-6 move-bottom">
									...
									<a href="services.html" className="services-wrap animate-box" data-animate-effect="fadeInRight">
										<div className="services-img" style={{backgroundImage:" url(images/services-5.jpg)"}}></div>
										<div className="desc">
				...
				<div className="colorlib-narrow-content">
					...
					<div className="row">
						...
						<div className="col-md-3 text-center animate-box">
							...
							<span className="colorlib-counter-label">Чистим в Цехе</span>
						</div>
						<div className="col-md-3 text-center animate-box">
